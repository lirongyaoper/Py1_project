...
group_two() {
  echo "2D U-Net 训练"
  CUDA_VISIBLE_DEVICES=0 nnUNetv2_train 001 2d 0 -p nnUNetResEncUNetLPlans --npz & CUDA_VISIBLE_DEVICES=1 nnUNetv2_train 001 2d 1 -p nnUNetResEncUNetLPlans --npz & CUDA_VISIBLE_DEVICES=2 nnUNetv2_train 001 2d 2 -p nnUNetResEncUNetLPlans --npz & CUDA_VISIBLE_DEVICES=3 nnUNetv2_train 001 2d 3 -p nnUNetResEncUNetLPlans --npz & CUDA_VISIBLE_DEVICES=4 nnUNetv2_train 001 2d 4 -p nnUNetResEncUNetLPlans --npz
  echo "2D U-Net 训练完成！！！"
}
