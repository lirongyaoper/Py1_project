...
def rename_last_level_directories(src):
    ...
    for root, dirs, files in os.walk(src):
        ...
        if not dirs:
            ...
            # 对目录路径使用("/")进行分割——lry
            name_all = parent_dir.split(
                '/')  # ['', 'media', 'lirongyaoper', '350142ad-6ead-4db5-b07c-25bd698ad3c7', 'lungCT', '300yuanshi', 'DI_TK96907975']
...
if __name__ == "__main__":
    # 使用示例
    source_directory = '/mnt/data/new500/100'  # 源目录路径
